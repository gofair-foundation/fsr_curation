...
1. Use the API: [**check duplicates**](https://nanodash.knowledgepixels.com/query?id=RARbQh51JW7ufDVdSdJEFEMiWiFo8WtBJ070RuPDRyLW0/get-gofair-qualified-things) by searching with the most common name (and similar names) of the FSR if there exists more than one nanopub.
