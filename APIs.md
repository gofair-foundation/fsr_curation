...
1. Use the API: [**check duplicates**](https://nanodash.knowledgepixels.com/query?id=RAfgJE8nia_5dXordL1zE2J2fSWWqVAFjloOt6IaToWtU/find-gofair-qualified-things) by searching with the most common name (and similar names) of the FSR if there exists more than one nanopub.
